 ...
 *
 * @param {String} [parameters.id] Gets the ID of the resource group.
 *
 ...
 *
 * @param {String} [parameters.properties.provisioningState] Gets resource group provisioning state.
 *
 ...
 * @returns {Stream} The Response stream
 */
ResourceGroups.prototype.beginDelete = function (resourceGroupName, options, callback) {
  var client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
    options = null;
