...
Tags.prototype.deleteValue = function (tagName, tagValue, options, callback) {
  ...
  try {
    ...
    if (tagName !== null && tagName !== undefined && typeof tagName !== 'string') {
      throw new Error('tagName must be of type string.');
    }
    if (tagValue === null || tagValue === undefined) {
      throw new Error('\'tagValue\' cannot be null');
    }
    if (tagValue !== null && tagValue !== undefined && typeof tagValue !== 'string') {
      throw new Error('tagValue must be of type string.');
    }
