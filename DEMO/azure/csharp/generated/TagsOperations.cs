...
namespace 
{
    ...
    internal partial class TagsOperations : IServiceOperations<ResourceManagementClient>, ITagsOperations
    {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<Page<TagDetails>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (this.Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
            ...
            // Create Result
            var result = new AzureOperationResponse<Page<TagDetails>>();
            result.Request = httpRequest;
            result.Response = httpResponse;
            if (httpResponse.Headers.Contains("x-ms-request-id"))
            {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<Page<TagDetails>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
